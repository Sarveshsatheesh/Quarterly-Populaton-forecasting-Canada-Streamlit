...
@st.cache
def read_data():
    path = r"D:\streamlit-population-canada-master\data\quarterly_canada_population.csv"
    #URL = "https://raw.githubusercontent.com/marcopeix/streamlit-population-canada/master/data/quarterly_canada_population.csv"
    df = pd.read_csv(path, index_col=0, dtype={'Quarter': str, 
                                          'Canada': np.int32,
...
@st.cache
def read_geojson():
    json_path = r"D:\streamlit-population-canada-master\data\canada.geojson"
